...
ConVar g_cvFlag, g_cvImmunity, g_cvGroup, g_cvTimeType, g_cvContactLen, g_cvMessageLen;
...
public void OnPluginStart()
{
	...
	g_cvTimeType 	= CreateConVar("sm_admins_timetype", "%x", "Format of time in menu. Read c++ documentation for more details.");
...
{ 
	...
	char sGroup[64], sTime[16], sBuffer[256], scvBuffer[16];
	...
	if(GetConVarInt(g_cvImmunity)) hMenu.SetTitle("%t", "DescriptionMenu_Imm", iTarget, iImmunity, sTime);
	else hMenu.SetTitle("%t", "DescriptionMenu", iTarget, sTime);
